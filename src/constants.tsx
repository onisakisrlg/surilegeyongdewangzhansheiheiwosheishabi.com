...
export const MOCK_PROJECTS: PrototypeProject[] = [
  ...
  },
  {
    ...
    specs: [
      {
        title: "界面结构",
        content: "1. 顶部全局导航栏：包含面包屑路径、全局搜索及系统工具。\n2. 侧边栏菜单：深色主题，‘仓储管理’项处于展开状态，‘仓储入库(2.0)’ 激活。\n3. 主工作区 - 流程进阶：顶部显示‘选择关联订单’与‘完善商品信息’两步流程。\n4. 搜索面板：多维度筛选条件（MID、快递单号、平台单号等），支持收起/展开功能。\n5. 数据展示：下方为最近成功入库记录表，采用带滚动条的表格展示详细信息。"
      }
    ]
  }
];
